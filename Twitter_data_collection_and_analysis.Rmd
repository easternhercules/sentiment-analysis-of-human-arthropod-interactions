...
#export
save_as_csv(spider_tweets, "c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIGx", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```

```{r readtweets}
#read
spider_tweets1 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG1.csv", unflatten = FALSE)
spider_tweets2 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG2.csv", unflatten = FALSE)
spider_tweets3 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG3.csv", unflatten = FALSE)
spider_tweets4 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG4.csv", unflatten = FALSE)
spider_tweets5 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG5.csv", unflatten = FALSE)
spider_tweets6 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG6.csv", unflatten = FALSE)
spider_tweets7 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG7.csv", unflatten = FALSE)
spider_tweets8 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG8.csv", unflatten = FALSE)
spider_tweets9 <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIG9.csv", unflatten = FALSE)
#append
...
```{r cleanexport}
#export
save_as_csv(spider_tweets, driver="CSV", "c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIGclean")
```

```{r cleanread}
#read
spider_tweets <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIGclean.csv")
```
...
```{r locatedexport}
#export
save_as_csv(spider_tweets_reordered, "C:/Users/ges_student/Desktop/quickzip/spiders06062020BIGlocated.csv", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```

```{r locatedread}
#read
spider_tweets_reordered <- read_twitter_csv("C:/Users/Julian/Downloads/R_files/data/spiders06062020BIGlocated.csv", unflatten = FALSE)
...
spider_tweets_reordered <- read_twitter_csv("c:/Users/ges_student/Desktop/Julian/vBIG/spiders06062020BIGlocated.csv", unflatten = FALSE)
...
```{r fixedexport}
#export
save_as_csv(spider_tweets_reordered@data, "C:/Users/Julian/Downloads/R_files/data/spiders06062020BIGlocated.csv", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```
...
#export
save_as_csv(spider_tweets_merged, "c:/Users/ges_student/Desktop/quickzip/vBIG/spiders06062020BIGmergedterms.csv", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```

```{r loadmerge}
spider_tweets_merged <- read_twitter_csv("C:/Users/Julian/Downloads/R_files/data/spiders06062020BIGmergedterms.csv", unflatten = FALSE)
```
...
#export
save_as_csv(words, "C:/Users/Julian/Downloads/R_files/data/words.csv", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
save_as_csv(spider_tweets_reordered@data, "C:/Users/Julian/Downloads/R_files/data/spiders06062020BIGsentiment.csv", prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
#load
words <- read_twitter_csv("C:/Users/Julian/Downloads/R_files/data/words.csv", unflatten = FALSE)
spider_tweets_sentiment <- read_twitter_csv("C:/Users/Julian/Downloads/R_files/data/spiders06062020BIGsentiment.csv", unflatten = FALSE)
...
ggplot(posnegtweets, aes(factor(type), count, fill = sentiment)) + geom_bar(stat="identity", position = "dodge") + 
  scale_fill_brewer(palette = "Set1") +
      labs(x = "Interaction",
      y = "Count",
      title = "Engagement of 1000 most positive vs. 1000 most negative spider tweets")        #overall pos/neg string sentiment
histogram <- hist(spider_tweets_sentiment@data$stringsentiment, main="Positive/negative sentiment of spider tweets", xlab="Sentiment", ylab="Frequency", labels=TRUE)
histogram
```
...
mean(posnegtweetsfull$favorite_count)
posnegtweetsfulllikes.aov <- aov(formula = favorite_count ~ sentiment,
                   data = posnegtweetsfull)
posnegtweetsfulllikes.lm <- lm(formula = favorite_count ~ sentiment,
                   data = posnegtweetsfull)
summary(posnegtweetsfulllikes.aov)
TukeyHSD(posnegtweetsfulllikes.aov)
summary(posnegtweetsfulllikes.lm)
#positive/negative tweet retweets
mean(posnegtweetsfull$retweet_count)
posnegtweetsfullretweets.aov <- aov(formula = retweet_count ~ sentiment,
                   data = posnegtweetsfull)
posnegtweetsfullretweets.lm <- lm(formula = retweet_count ~ sentiment,
                   data = posnegtweetsfull)
summary(posnegtweetsfullretweets.aov)
TukeyHSD(posnegtweetsfullretweets.aov)
summary(posnegtweetsfullretweets.lm)
```
