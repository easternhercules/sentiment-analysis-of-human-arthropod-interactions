...
```{r readtweets}
#read
spider_tweets1 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG1.csv"), unflatten = FALSE)
spider_tweets2 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG2.csv"), unflatten = FALSE)
spider_tweets3 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG3.csv"), unflatten = FALSE)
spider_tweets4 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG4.csv"), unflatten = FALSE)
spider_tweets5 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG5.csv"), unflatten = FALSE)
spider_tweets6 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG6.csv"), unflatten = FALSE)
spider_tweets7 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG7.csv"), unflatten = FALSE)
spider_tweets8 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG8.csv"), unflatten = FALSE)
spider_tweets9 <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIG9.csv"), unflatten = FALSE)
#append
...
```{r cleanexport}
#export
save_as_csv(spider_tweets, driver="CSV", here::here("R_files_Twitter", "data", "spiders06062020BIGclean"), unflatten = FALSE))
```

```{r cleanread}
#read
spider_tweets <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIGclean.csv"), unflatten = FALSE)
```
...
```{r locatedexport}
#export
save_as_csv(spider_tweets_reordered, here::here("R_files_Twitter", "data","spiders06062020BIGlocated.csv"), prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```

```{r locatedread}
#read
spider_tweets_reordered <- read_twitter_csv(here::here("R_files_Twitter", "data","spiders06062020BIGlocated.csv"), unflatten = FALSE)
...
```{r fixedexport}
#export
save_as_csv(spider_tweets_reordered@data, here::here("R_files_Twitter", "data", "spiders06062020BIGlocated.csv"), prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```
...
#export
save_as_csv(spider_tweets_merged, here::here("R_files_Twitter", "data", "spiders06062020BIGmergedterms.csv"), prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
```

```{r loadmerge}
spider_tweets_merged <- read_twitter_csv(here::here("R_files_Twitter", "data", "spiders06062020BIGmergedterms.csv"), unflatten = FALSE)
```
...
#export
save_as_csv(words, here::here("R_files_Twitter", "data", "words.csv"), prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
save_as_csv(spider_tweets_reordered@data, here::here("R_files_Twitter", "data", "spiders06062020BIGsentiment.csv"), prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")
#load
words <- read_twitter_csv(here::here("R_files_Twitter", "data", "words.csv"), unflatten = FALSE)
